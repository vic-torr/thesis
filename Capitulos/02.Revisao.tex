...
A MSP é o núcleo do \textit{encoder}\footnote{Codificadoe} implementa o mecanismo de auto atenção. Consiste em relacionar diferentes posições de uma única sequência para se computar uma representação desta sequencia \cite{AttentionIsAllYouNeed}.
