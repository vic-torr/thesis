...
Para classificações multi-classes, são utilizadas camadas de saída que implementam normalização para selecionar a probabilidade de cada classe.
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=\columnwidth]{Imagens/mapas de caracteristicas hierarquico swin vs vit.png}
    \caption{Mapa de características hierarquico transformer swin ~\cite{liu2022swin}}
    \label{fig:SWIN}
\end{figure}

\begin{figure}[!ht]
    \centering
    \includegraphics[width=\columnwidth]{Imagens/janela deslocada swin.png}
    \caption{Mapa de características hierarquico transformer swin ~\cite{liu2022swin}}
    \label{fig:SWIN-mapa-hierarquico}
\end{figure}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=\columnwidth]{Imagens/dois blocos swin sucessivos.png}
    \caption{Arquitetura swin ~\cite{liu2022swin}}
    \label{fig:SWIN-blocos-sucessivos}
\end{figure}
