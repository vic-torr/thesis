...
A rede é composta por camadas convolucionais e de pooling, que funciona como extrator de características. Treinada previamente em uma região similar ao do conjunto de dados geolocalizado, para obter melhor generalização. As camadas seguintes são camadas totalmente conectadas seguidas por uma camada softmax que realiza regressão das coordenadas.
...
Primeira etapa:
%% Como escolheu camadas convolucionais?
%% Como escolheu polling?
%% Como escolheu camada de saida?
%% Como escolheu função de perda?
%% Como escolheu algoritomo de otimização?
%% Como escolheu modelo?
%% Tunning
%% Validation
%% Otimização da rede
%% Validation on jetson, get stats
%% CoordConv

Segunda etapa: %% getting generalization
%% Data augmentation
%% Feature extraction -> data set dependent
%% transfer learning
%% validation with drone data
%% last measurements as inpput
%% autoenconders? multi channel filters
